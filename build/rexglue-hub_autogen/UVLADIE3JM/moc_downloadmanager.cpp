...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(qint64 , qint64 )>(_a, &DownloadManager::progress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(const QString & )>(_a, &DownloadManager::finished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(const QString & )>(_a, &DownloadManager::errorOccurred, 2))
            return;
    }
}
...
// SIGNAL 0
void DownloadManager::progress(qint64 _t1, qint64 _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void DownloadManager::finished(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void DownloadManager::errorOccurred(const QString & _t1)
{
